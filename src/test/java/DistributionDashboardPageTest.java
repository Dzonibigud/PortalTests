...
public class DistributionDashboardPageTest extends BaseTest{
    @Test @Story("Distribution Dashboard Tab landing page")
    @Description("Test verifies that Distribution Dashboard Tab opens")
    @Severity(SeverityLevel.NORMAL) @Tag("Regression")@Tag("Smoke")
    ...
    @Test @Story("Distribution Dashboard Show Filter button functionality")
    ...
    @Test @Story("Distribution Dashboard Hide Network button functionality")
    ...
    @Test @Story("Distribution Dashboard ISIN Filter selecting 2 isins")
    ...
    @Test @Story("Distribution Dashboard Reset Filter functionality")
