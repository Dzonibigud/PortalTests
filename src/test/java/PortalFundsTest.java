...
public class PortalFundsTest extends BaseTest {
    ...
    @Test
    @Story("Collapse button functionality")
    @Description("Test verifies that collapse button functions")
    @Severity(SeverityLevel.NORMAL)
    @Step("Clicking on collapse button")
    @Tag("Regression")
    ...
    @Test
    @Story("Back To Top button functionality")
    @Description("Test verifies that back to top button functions")
    @Severity(SeverityLevel.NORMAL)
    @Step("Clicking on back to top button")
    @Tag("Regression")
    ...
    @Test
    @Story("Fund Name Filter Functionality")
    @Description("Test verifies that Fund Name filter search functions")
    @Severity(SeverityLevel.NORMAL)
    @Step("typing into fund name search field")
    @Tag("Regression")
    ...
    @Test
    @Story("ISIN field Filter Functionality")
    @Description("Test verifies that ISIN filter search functions")
    @Severity(SeverityLevel.NORMAL)
    @Step("typing into ISIN search field")
    @Tag("Regression")
    void iSINFilterTest(){
        LoginPage loginPage = new LoginPage(driver);
        PortalPage portalPage = loginPage.login(ConfigReader.getProperty("email"), ConfigReader.getProperty("password"));
    ...
    @Test
    @Story("Opening Share Class")
    @Description("Test verifies that user can open share class")
    @Severity(SeverityLevel.NORMAL)
    @Step("Clicking on First Share Class")
    @Tag("Regression")
