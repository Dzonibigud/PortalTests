...
public class PortalTest1 extends BaseTest {
        WebDriver driver;
        ...
        @Test//10. Testing of funds/anyshareClass> Documents page if it is working
        ...
        @Test    //11. Testing of funds/anyshareClass> NAV History page if it is working
    ...
    @Test    //12. Testing of funds/anyshareClass> NAV History export is working
    ...
    void shareClassTestNavHistoryExport() throws InterruptedException {
        ...
        @Test //13. Testing of funds/anyshareClass> Distribution page if it is working
        ...
        @Test  //14. Testing of distribution Dashboard tab, testing of all buttons functionality and export(file download)
        ...
        @Test //15. Notification Button test
        ...
        @Test //16. Notification checking first row for anything
        ...
        @Test //17. Notification attachment try download
        ...
        @Test //18 Sorting order date/subject
